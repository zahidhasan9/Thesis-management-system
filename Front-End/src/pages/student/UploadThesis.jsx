...
export default function UploadThesis() {
  ...
  const loadSubmissionStatus = async () => {
    try {
      ...
      const res = await axios.get("/student/submission-status");
  ...
  const isSubmissionClosed = deadlineInfo?.isOpen === false;

  const formatDeadline = (dateValue) => {
    if (!dateValue) return "Not set by admin";
  ...
  const upload = async () => {
    if (deadlineLoading) {
      toast.error("Please wait. Checking submission deadline.");
      return;
    }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-8">
          <button
            onClick={() => navigate(-1)}
            className="w-fit inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition shadow-sm mb-5"
          >
            <ArrowLeft className="w-4 h-4" />
            Back
          </button>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Submit your thesis document in PDF format before the admin-set
                deadline.
              </p>
            </div>
        ...
        {/* Closed alert */}
        {!deadlineLoading && isSubmissionClosed && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-red-800">
                  Thesis submission is currently closed
                </h3>

                <p className="text-sm text-red-700 mt-1">
                  {deadlineInfo?.message ||
                    "Students cannot upload thesis after the deadline."}
                </p>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                <label
                  className={`block border border-dashed rounded-xl p-6 transition ${
                    disableForm
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
              ...
              >
                ...
                <p
                  className={`text-sm font-semibold ${
                    isSubmissionClosed ? "text-red-800" : "text-green-800"
                  }`}
                >
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
              ...
              <div className="space-y-3 text-sm text-gray-600 leading-6">
                ...
                <p>• Make sure the thesis title is accurate and complete.</p>
                <p>• Review your file before submitting.</p>
                <p>• Upload will be blocked after the admin-set deadline.</p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <p className="text-sm text-gray-600 leading-7">
                  Once uploaded, your thesis status may remain pending until
                  reviewed by your supervisor. If your thesis is declined, you
                  may need to update and re-upload it before the deadline.
                </p>
              </div>
            </div>
